...
*   **Responsibilities**:
    ...
    *   **Data Retrieval**: Fetching worker groups, inputs (sources), outputs (destinations), and system status/metrics from the Cribl instance.
...
*   **Responsibilities**:
    ...
    *   Overlaying node descriptions and runtime metrics (like EPS) onto node labels.
