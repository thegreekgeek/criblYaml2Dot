...
*   [Architecture Overview](docs/ARCHITECTURE.md) - System overview, component details, and data flow.
*   [Code Reference](docs/CODE_REFERENCE.md) - Detailed class references and logic.
